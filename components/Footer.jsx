    ...
    <footer className="footer-main">
      <div className="footer-content">
        ...
        <div className="footer-column stats-col">
          <h3 className="stats-title">By 2035</h3>
          <ul className="stats-list">
            <li>500+ African Billionaires</li>
            <li>10,000+ Millionaires</li>
            <li>1,000+ African Tech Companies</li>
            <li>500+ Global Brands</li>
        ...
        <div className="footer-column brand-col">
          ...
          <p className="brand-tagline"><em>The Revolution Building Nigeria's Next Billionaires</em></p>
      ...
      <div className="footer-bottom">
        <p className="attribution">
          Built on the documented wisdom of the world's most successful leaders. Every principle inside FoxRevo is cited, attributed, and traceable to its origin. FoxRevo is not the author of this knowledge. FoxRevo is the bridge that brings it to Africa.
        </p>
        <p className="signoff" style={{ fontStyle: 'italic' }}>With love for Nigeria. With belief in Africa. With urgency for this generation.</p>
